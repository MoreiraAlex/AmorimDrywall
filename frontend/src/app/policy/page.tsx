...
export default function Policy() {
  return (
    <section className="container mx-auto p-5 pt-48 md:p-20">
      <div className="mb-12">
        <Title.Root className="mb-12">
          <Title.H1>Política de Privacidade</Title.H1>
        </Title.Root>
        <p className="mb-1">
          A sua privacidade é importante para nós. É política do site
          AmorimDrywall respeitar a sua privacidade em relação a qualquer
          informação sua que possamos coletar no site{' '}
          <strong>AmorimDrywall</strong>, e outros sites que possuímos e
          operamos.
        </p>
        <p className="mb-1">
          Trabalhamos com base na Lei de Proteção de Dados (13.709/2018) que
          traz garantias de privacidade, confidencialidade, retenção, proteção
          aos direitos fundamentais de liberdade e o livre desenvolvimento da
          personalidade da pessoa. Além disso, respeitamos a Constituição
          Federal da República Federativa do Brasil, o Código de Defesa do
          Consumidor (Lei 8.078/90), Marco Civil da Internet (Lei 12.965/14).
        </p>
        <p className="mb-1">
        ...
        <p className="mb-1">
          ...
          ou com terceiros, exceto por determinação judicial.
        </p>
        <p className="mb-1">
          O nosso site pode ter links para sites externos que não são operados
          por nós. Diante disto, não nos responsabilizamos por danos de
          terceiros. Esteja ciente de que não temos controle sobre o conteúdo e
          práticas de sites de terceiros e não podemos aceitar responsabilidade
        ...
        <p className="mb-1">
          ...
          {/*Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contato conosco através <a href="URL" target="_blank">do nosso formulário</a>.*/}
        </p>
        <p className="mb-1">Nossa política é atualizada de forma constante.</p>
        <p className="mb-1">
          Fica, desde já, o titular de dados ciente que o conteúdo desta
          Política de Privacidade pode ser alterado a critério do site
          AmorimDrywall, independente de aviso ou notificação. Em caso de
          alteração, as modificações produzem todos os efeitos a partir do
          momento da disponibilização no site.
        </p>
        <p className="mb-1">
          O site AmorimDrywall não se responsabiliza caso você venha utilizar
          seus dados de forma incorreta ou inverídica, ficando excluído de
          qualquer responsabilidade neste sentido.
        </p>
      </div>

      <div className="mb-12">
        <Title.Root className="mb-6">
          <Title.H2>Política de Cookies</Title.H2>
        </Title.Root>
        <Title.Root className="mb-2">
          <Title.H3>O que são cookies?</Title.H3>
        </Title.Root>
        <p className="mb-1">
        ...
        <Title.Root className="mb-2">
          <Title.H3>Como usamos os cookies?</Title.H3>
        </Title.Root>
        <p className="mb-1">
        ...
        <Title.Root className="mb-2">
          <Title.H3>Desativar cookies</Title.H3>
        </Title.Root>
        <p className="mb-1">
        ...
        <Title.Root className="mb-2">
          <Title.H3>Cookies que definimos</Title.H3>
        </Title.Root>
        <ul className="list-disc">
          ...
          <li className="my-2 ml-4">
            ...
            chamadas sempre que você interagir com uma página que for afetada
            por suas preferências.
          </li>
        </ul>
        <Title.Root className="mb-2">
          <Title.H3>Cookies de Terceiros</Title.H3>
        </Title.Root>
        <p className="mb-1">
        ...
        <Title.Root className="mb-2">
          <Title.H3>Compromisso do Usuário</Title.H3>
        </Title.Root>
        <p className="mb-1">
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o site AmorimDrywall oferece e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ol className="list-[upper-roman]">
          ...
          <li className="my-2 ml-4">
            Respeito a todas as legislações nacionais ou internacionais em que o
            Brasil é signatário;
          </li>
          <li className="my-2 ml-4">
          ...
          <li className="my-2 ml-4">
            ...
            do site AmorimDrywall, de seus fornecedores ou terceiros, para
          ...
          <li className="my-2 ml-4">
            Os conteúdos publicados, possuem direitos autorais e de propriedade
            intelectual reservados, conforme estabelece a Lei de Direitos
            Autorais n. 9.610, de 19.2.1998 do Governo Federal Brasileiro e
            correlatas. Qualquer infringência, serão comunicados às autoridades
            competentes.
          </li>
        </ol>
      </div>
      ...
      <div className="mb-12">
        <Title.Root className="mb-6">
          <Title.H2>Mais informações</Title.H2>
        </Title.Root>
        <p className="mb-1">
        ...
        <p className="mb-1">
          O site AmorimDrywall empregará esforços para resguardar as informações
          e dados coletados do usuário pelo site. Todavia, considerando que não
          há meio de transmissão e retenção de dados eletrônicos plenamente
          eficaz e seguro, o site AmorimDrywall não pode assegurar que terceiros
          não autorizados não logrem êxito no acesso indevido, eximindo-se de
          qualquer responsabilidade por danos e prejuízos decorrentes da conduta
          de terceiros, ataques externos ao site como: vírus, invasão ao banco
          de dados, vícios ou defeitos técnicos, assim como operacionais
